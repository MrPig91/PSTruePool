...
$moduleName = 'PSTruePool'
$homedirectory = Join-Path -Path $env:GITHUB_WORKSPACE -ChildPath "PSTruePool"
...
$manifestParameters = @{
     ...
     Author = "Mrpig91"
     Description = "A powershell module for interacting TruePool's API."
}
...
Publish-Module -Path $homedirectory -NuGetApiKey $env:PWSHGALLERY -Tags "TruePool","API"